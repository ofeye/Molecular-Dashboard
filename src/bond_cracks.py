...
from scripts.utils.file_utils import getDataSRealSize
...
def get_atom_data(surface1, surface2, a_val, h_perc, k_val, time_step, cutoff):
    ...
    prev_timestep_data = getDataSRealSize(time_step - 1, file_path) if time_step > 1 else None
    now_timestep_data = getDataSRealSize(time_step, file_path)
